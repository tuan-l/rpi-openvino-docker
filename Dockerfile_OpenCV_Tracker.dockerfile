...
RUN apt install -y libjasper1 libhdf5-dev libilmbase-dev libopenexr-dev libgstreamer1.0-dev libqtgui4
...
ENV PYTHONPATH="/usr/local/lib/python3.5/dist-packages:${OPENVINO_DIR}/python/python3.5/armv7l/:${PYTHONPATH}"
COPY ./code ./code
